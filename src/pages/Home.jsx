...
const Home = () => {
    ...
    const { data: postsData, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const response = await axios.get(`/posts?page=${page}${currentTag ? `&tag=${currentTag}` : ''}`);
            ...
            <div className='container mx-auto'>
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    {isTagsLoading ? (
                        ...
                        <TagsSection tags={tags} currentTag={currentTag} setCurrentTag={setCurrentTag} />
                    )}
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <PostsSection postsData={{ ...postsData, posts: filteredPosts }} setPage={setPage} />
